...
using UnityEditor;
#endif
public class A_DoodleMaster : MonoBehaviour
{
    [Header("DEV SETTINGS")]
    ...
    [Header ("Attributes")]
    public A_Doodle DoodlerPrefab;
    A_Doodle _currentDoodler;
    [SerializeField] List<A_Doodle> _DoodlesList; // currently serialized for visibility
    ...
    public void EndDoodlin()
    {
        ...
        DrawingOutput.AddRange(_currentDoodler.ReturnPointOutput(0));
    ...
    public void SetALLDOODLESColor(Color targetColor, float targetAlpha)
    {
        ...
        foreach (A_Doodle d in _DoodlesList)
        {
